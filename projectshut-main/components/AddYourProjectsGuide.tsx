...
const option1Steps = [
  ...
  {
  text: "Congratulations🎉, you have made a PR to ProjectX. Wait for your submission to be accepted and your PR to be merged by a maintainer.",
  },
];
...
const option2Steps = [
  ...
  {
    steps: "Step 3 : ",
  text: "Navigate to the ProjectX directory",
  code: "cd ProjectX",
    image:
    ...
    <>
      ...
      <article className="items-center max-w-5xl mx-auto">
        <Motion.p
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5, type: "spring", stiffness: 110 }}>
          Follow these steps to add your projects to ProjectX:
        </Motion.p>
